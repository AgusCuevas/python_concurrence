...
threading.Thread(target=crearAnimacion, args=(10,10, 'X')).start()
threading.Thread(target=crearAnimacion, args=(10,30, 'Y')).start()
threading.Thread(target=crearAnimacion, args=(10,50, 'Z')).start()
